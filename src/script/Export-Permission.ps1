...
#Requires -Module @{ ModuleName = 'Permission' ; RequiredVersion = '0.0.1230' }
...
begin {
    ...
    # This cannot be moved into a function because Get-Variable needs access to the variables not in $PSBoundParameters.
