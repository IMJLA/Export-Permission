...
.NOTES
    ...
    - Bug - Get-WellKnownSid repeatedly creating CIM sessions to same destination in domain env? verify still ongoing.  Add debug output suffix "# For $ComputerName" so debug is easier to read
